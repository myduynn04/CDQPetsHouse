...
if(isset($_POST['btn_save'])) {
    ...
    $tsql = "INSERT INTO user_info (first_name, last_name, email, password, mobile, address1, address2) 
             VALUES (?, ?, ?, ?, ?, ?, ?)";
    
    $params = array($first_name, $last_name, $email, $user_password, $mobile, $address1, $address2);
